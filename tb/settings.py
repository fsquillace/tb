...
def full_path(filename):
    return (os.path.dirname(__file__)+'/'+filename).replace('\\','/')
...
DATABASES = {
    'default': {
        ...
        'NAME': full_path('sqlite.db'),                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = full_path('/public/static')
...
SECRET_KEY = '4*#8@385gkf_+2328z&amp;axu6e-spo8ggkf!)o#doo=zf#tw65op'
